//
//  NSAttributedString+YJAttributedString.m
//  YJFoundationDemo
//
...
@implementation NSAttributedString (YJAttributedString)
...
+ (NSAttributedString *)yj_attributeStringWithPrefixString:(NSString *)prefixString
    ...
    return [NSAttributedString yj_attributeStringWithPrefixString:prefixString
...
+ (NSAttributedString *)yj_attributeStringWithPrefixString:(NSString *)prefixString
    ...
    if ([NSString yj_checkEmptyWithString:prefixString] || [NSString yj_checkEmptyWithString:suffixString]) {
